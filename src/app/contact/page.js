...
export default function contact() {
    return (
        ...
        <div>
        <div
                className="px-6 py-12 text-gray-800 text-center lg:text-left">
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <h1
                                    className="text-4xl md:text-5xl xl:text-6xl font-bold tracking-tight mb-12">
                                    Contact
                                    <br />
                                    <span
                                ...
                                <Link className="inline-block px-7 py-3 bg-transparent text-blue-600 font-medium text-sm leading-snug uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Mail</Link>
                            </div>
                            <div>
                                <img
                                    className="w-full rounded-lg shadow-lg"
                                    src="https://images.unsplash.com/photo-1629799759695-c1e9478a4d18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1176&q=80" />
                            </div>
                        </div>
            ...
            <div className="container my-24 px-6 mx-auto">
                <section className="mb-32 text-gray-600">
                    <div className="flex justify-center">
                        <div className="text-3xl lg:max-w-3xl md:max-w-xl">
                            <h2 className="text-3xl font-bold mb12 px-6"></h2>
                        </div>
                    </div>
